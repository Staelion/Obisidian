...
>[!INFO]
>
># Fiche de Révision - Stimulation Osseuse
>
> ## I. Situations d'échec
> - Surdité de transmission non opérable (multiples interventions, fibrose...)
> - Surdité de transmission non appareillable (sténose du CAE, suppuration, Évidement Petro Mastoïdien)
> - Surdité mixte ou de perception non appareillable
>   - Mauvaise tolérance
>   - Seuils auditifs trop bas
>
> ## II. Réhabilitation par Voie Osseuse
> - Surdité de transmission ou mixte (bonne)
> - Nécessite une courbe osseuse satisfaisante
>
> ## III. Implant d'Oreille Moyenne
> - Amplification par dispositif implanté dans l'OM (chaîne ossiculaire, fenêtre ronde/ovale)
> - Surdité de perception non applicables
> - Surdités mixtes non opérables et non appareillables
>
> ## IV. Voie Osseuse - Histoire
> - Ludwig Von Beethoven avait une otospongiose (1770-1827) et utilisait une tige de bois sur son piano.
> - 1879 : dentaphone, membrane fixée au bout d’une tige entre les dents.
...
> - Cophose unilatérale (en concurrence avec le système CROS)
>
> ## VII. Indications
> - [[Surdité mixte]], [[surdité de transmission]]
>   - Niveau de courbe osseuse
>   - Puissance des processeurs/atteinte neurosensorielle
>   - Alternatives chirurgie/implant d’OM
> - Cophose unilatérale
>   - Niveau de performance de l’oreille controlatérale
> - Surdité de transmission non opérable.
>
> ## VI. Dispositifs
> - **Prothèse Externe**
>   - Prothèses à CO sur lunettes
>     - Pression sur la mastoïde (douleurs)
>     - Bruit lors des mouvements
>     - Difficultés lors du retrait des lunettes
>   - Softband (bandeau)
>     - Processeur vibratoire sur bandeau souple
>     - Stimulation osseuse dès le diagnostic de surdité de transmission
>     - Indication dans les aplasies, mais des difficultés lorsque l'enfant grandit
>   - Prothèse adhérente à la peau (ADHEAR de Medel)
>     - Système adhésif changé 2 fois par semaine
>     - Vibrateur externe, stimulation équivalente à softband et headband
>     - Mise sur le marché en 2017 en Europe
>   - Soundarc Cochléar
>     - Système transitoire
> - **Implants**
>   - Passage trans et per cutané (traverse la peau)
>   - Vibration externe ou interne (aimant)
>
...
>   - Remboursement
>
> ## XII. Quand Proposer une Voie Osseuse ?
> - Échec de solutions plus simples
> - Surdité de transmission
> - Geste chirurgical fonctionnel
> - Prothèse auditive conventionnelle
> - Cophose unilatérale
> - Cros WIFI
>
> ## XIII. Quel Implant ?
> - Nécessité d'une puissance de stimulation
> - Surveillance d'une pathologie par IRM
> - Anatomie du patient (chez les petits enfants, gros systèmes)
>
> ## XIV. Surdité de Transmission
> - AdHEAR ou Soundarc si stable dans le temps
> - Aplasie majeure : Peu d'énergie, pas de pathologie à surveiller
>   - Sophono ou Attract
>   - Mastoïde de petite taille chez les enfants
> - Cholestéatome ou tumeur du rocher récents
>   - BAHA
> - Patient immunodéprimé
>   - Pas de passage percutané (surtout pas de BAHA en raison du risque d'infection)
>

> [!INFO]
> # Fiche de Révision - Implants d'Oreille Moyenne
>
> ## XVI. Conditions d'un IOM
> - Oreille nécessitant d'être appareillée
> - Échec d'appareillage conventionnel ou d'une autre solution plus simple (geste ossiculaire, voie osseuse...)
> - Oreille interne ayant la capacité d'optimiser l'amplification (non-indication d'IC)
> - Surdité stable ou peu évolutive (impossible sur la maladie de Ménière...)
>
> ## XVII. Types de Prothèses
> - Transducteur piézo-électrique : entre la chaîne ossiculaire et un point d'ancrage dans la mastoïde
> - Transducteur électromagnétique
>
> ## XVIII. Dispositifs Disponibles
> - **Vibrant Soundbridge (Medel)**
>   - 1998
> - **Otologics**
>   - MET 2001 (non commercialisé)
> - **CARINA 2006** (abandonné)
> - **Esteem Envoy (St Croix Medical)**
>   - 2007
> - **DACS (Direct Acoustic Cochlear Stimulator)**
>   - 2008
>
> ## XIX. Vibrant Soundbridge
> - Apporte une vibration à la cochlée (fixation sur les osselets ou la fenêtre ronde)
> - Stimulation préopératoire possible avec DDS (Direct Drive Simulator)
> - Implant sous la peau derrière l'oreille, fixation à l'enclume par exemple
>
> ## XX. MET Otologics (non commercialisé)
>
> ## XXI. Carina (Abandonné il y a 2 ans)
> - Totalement implantable, microphone sous la peau, aimant pour recharger le processeur la nuit
> - Problème du micro atténué sous la peau, utilisé pour surdité moyenne
> - Problèmes de recharge à long terme des batteries
>
> ## XXII. Envoy Esteem
> - Intervention longue, désarticulation de la chaîne, section laser de la BDE
> - Vissage d'un piezo dans le corps de l'enclume
...
> - Surdité de perception vocale < 50% à 60 dB : Indication pour l'IC
